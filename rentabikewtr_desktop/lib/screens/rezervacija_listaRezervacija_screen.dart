        ...
        children: [
          ...
          ElevatedButton(
              onPressed: () async {
                ...
                if (bic?.biciklId != null) {
                  tmpdataR = await _rezervacijeBiciklProvider
                      ?.get(_searchController.value);
                } else {
                  tmpdataR = await _rezervacijeBiciklProvider?.get(null);
                }

                setState(() {
                  dataRezervacije = tmpdataR!;
                });

                print("data: ${data[0].biciklId}");
              },
              child: Text("Pretraga")),
          SizedBox(
            width: 8,
