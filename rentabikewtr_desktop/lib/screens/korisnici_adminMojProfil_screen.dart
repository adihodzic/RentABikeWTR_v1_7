...
class KorisniciAdminMojProfilScreen extends StatefulWidget {
  // final KorisniciPregled argumentsK;
  const KorisniciAdminMojProfilScreen({super.key});

  @override
  State<KorisniciAdminMojProfilScreen> createState() =>
      _KorisniciAdminMojProfilScreenState();
}

class _KorisniciAdminMojProfilScreenState
    extends State<KorisniciAdminMojProfilScreen> {
