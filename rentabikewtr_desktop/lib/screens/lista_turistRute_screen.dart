...
class ListaTuristRuteScreen extends StatefulWidget {
  const ListaTuristRuteScreen({super.key});

  @override
  State<ListaTuristRuteScreen> createState() => _ListaTuristRuteScreenState();
}

class _ListaTuristRuteScreenState extends State<ListaTuristRuteScreen> {
  TuristRutePregledProvider? _turistRuteProvider = null;
  TuristickiVodiciPregledProvider? _turistickiVodiciPregledProvider = null;
  //CartProvider? _cartProvider = null;
  List<TuristRutePregled> data = [];
  ...
  void initState() {
    ...
    super.initState();
    _turistRuteProvider = context.read<TuristRutePregledProvider>();
        ...
        children: [
          ...
          ElevatedButton(
              onPressed: () async {
                ...
                var tmpdata = await _turistRuteProvider?.get();
  ...
  Widget _buildDataListView() {
    ...
    return Expanded(
      ...
      child: DataTable(
          ...
          rows: data
                  .map((TuristRutePregled e) => DataRow(
