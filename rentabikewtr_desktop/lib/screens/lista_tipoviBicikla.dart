...
import 'package:rentabikewtr_desktop/screens/tipoviBicikla_detalji_screen.dart';
...
class ListaTipoviBiciklaScreen extends StatefulWidget {
  const ListaTipoviBiciklaScreen({super.key});

  @override
  State<ListaTipoviBiciklaScreen> createState() =>
      _ListaTipoviBiciklaScreenState();
}

class _ListaTipoviBiciklaScreenState extends State<ListaTipoviBiciklaScreen> {
  ...
  List<TipoviBiciklaPregled> data = [];
  ...
  Future loadData() async {
    var tmpData = await _tipoviBiciklaPregledProvider?.get(null);
    setState(() {
      data = tmpData!;
    });
  }
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Column(children: [
                        ...
                        Text(
                          "RentABikeWTR -Lista tipova bicikla",
                          style: TextStyle(
                              fontSize: 30,
        ...
        children: [
          ...
          ElevatedButton(
              onPressed: () async {
                ...
                var tmpdata = await _tipoviBiciklaPregledProvider?.get();
  ...
  Widget _buildDataListView() {
    ...
    return Expanded(
      ...
      child: DataTable(
          ...
          rows: data
                  .map((TipoviBiciklaPregled e) => DataRow(
