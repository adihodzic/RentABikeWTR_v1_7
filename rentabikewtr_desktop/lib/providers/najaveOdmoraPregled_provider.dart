...
class NajaveOdmoraPregledProvider extends BaseProvider<NajaveOdmoraPregled> {
  NajaveOdmoraPregledProvider()
      : super("NajaveOdmora/Pregled"); //ako promijenim
  //...ovaj key onda moram promijeniti i rutu u bicikli_list_screen.dart
  @override
  NajaveOdmoraPregled fromJson(data) {
    return NajaveOdmoraPregled.fromJson(data);
  }
}
