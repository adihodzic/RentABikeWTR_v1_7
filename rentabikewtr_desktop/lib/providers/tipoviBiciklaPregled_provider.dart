...
class TipoviBiciklaPregledProvider extends BaseProvider<TipoviBiciklaPregled> {
  TipoviBiciklaPregledProvider() : super("TipoviBicikla"); //ako promijenim
  //...ovaj key onda moram promijeniti i rutu u bicikli_list_screen.dart
  @override
  TipoviBiciklaPregled fromJson(data) {
    return TipoviBiciklaPregled.fromJson(data);
  }
}
