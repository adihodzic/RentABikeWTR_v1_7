...
class VelicineBiciklaPregledProvider
    extends BaseProvider<VelicineBiciklaPregled> {
  VelicineBiciklaPregledProvider() : super("VelicineBicikla"); //ako promijenim
  //...ovaj key onda moram promijeniti i rutu u bicikli_list_screen.dart
  @override
  VelicineBiciklaPregled fromJson(data) {
    return VelicineBiciklaPregled.fromJson(data);
  }
}
