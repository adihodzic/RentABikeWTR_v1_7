...
class ServisiranjaDetaljiProvider extends BaseProvider<ServisiranjaDetalji> {
  ServisiranjaDetaljiProvider() : super("Servisiranja"); //ako promijenim
  //...ovaj key onda moram promijeniti i rutu u bicikli_list_screen.dart
  @override
  ServisiranjaDetalji fromJson(data) {
    return ServisiranjaDetalji.fromJson(data);
  }
}
