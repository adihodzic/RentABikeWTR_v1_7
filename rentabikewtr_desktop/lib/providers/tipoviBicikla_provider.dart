...
class TipoviBiciklaProvider extends BaseProvider<TipoviBicikla> {
  TipoviBiciklaProvider() : super("TipoviBicikla"); //ako promijenim
  //...ovaj key onda moram promijeniti i rutu u rezervacija_korak2_screen.dart
  @override
  TipoviBicikla fromJson(data) {
    return TipoviBicikla.fromJson(data);
  }
}
