...
class ModeliBiciklaProvider extends BaseProvider<ModeliBicikla> {
  ModeliBiciklaProvider() : super("ModeliBicikla"); //ako promijenim
  //...ovaj key onda moram promijeniti i rutu u rezervacija_korak2_screen.dart
  @override
  ModeliBicikla fromJson(data) {
    return ModeliBicikla.fromJson(data);
  }
}
