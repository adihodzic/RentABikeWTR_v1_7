...
class ServisiranjaPregledProvider extends BaseProvider<ServisiranjaPregled> {
  ServisiranjaPregledProvider()
      : super("Servisiranja/Pregled"); //ako promijenim
  //...ovaj key onda moram promijeniti i rutu u bicikli_list_screen.dart
  @override
  ServisiranjaPregled fromJson(data) {
    return ServisiranjaPregled.fromJson(data);
  }
}
