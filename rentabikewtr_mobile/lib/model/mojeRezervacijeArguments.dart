...
import 'rezervacijePregled.dart';
...
//@JsonSerializable()
class MojeRezervacijeArguments {
  KorisniciProfil? argumentsKor;
  RezervacijePregled? rezPregled;
  Bicikli? argumentsBic;
  //int? argumentsTVID;
  //TuristRute? argumentsTRID;
  MojeRezervacijeArguments(
      this.rezPregled, this.argumentsKor, this.argumentsBic);
}
